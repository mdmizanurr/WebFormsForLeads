...
namespace API.DTO
{
    public class ApiResult<T>
    {
        ...
        #region Methods    
        public static bool IsValidProperty(string propertyName, bool throwExceptionIfNotFount = true)
        {
            var prop = typeof(T).GetProperty(propertyName, BindingFlags.IgnoreCase | BindingFlags.Public | BindingFlags.Public | BindingFlags.Instance);

            if (prop == null && throwExceptionIfNotFount)
